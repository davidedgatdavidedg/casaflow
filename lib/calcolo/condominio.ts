 ...
 * sempre un importo assoluto annuo). Valore di mercato — NON normato per
 * legge. Per un affitto standard, le spese condominiali ORDINARIE
 * (pulizie scale, portineria, ascensore) sono per legge a carico
 * dell'inquilino (art. 9, Legge 27 luglio 1978, n. 392); solo le
 * STRAORDINARIE (facciata, tetto, impianti comuni) restano a carico del
 * proprietario. Questo default rappresenta una stima della sola quota
 * straordinaria media annua, non l'intera spesa condominiale.
 */
export const COSTO_CONDOMINIO_DEFAULT_PER_MQ = 20;
