...
export const VOCI_DOCUMENTATE: VoceDocumentata[] = [
  ...
  },
  {
    ...
    categoria: "investimenti",
    campiInput: ["prezzo-acquisto", "ristrutturazione", "coefficiente-valorizzazione-ristrutturazione", "rivalutazione-annua", "anni-investimento"],
    comeSiCalcola:
      "(Prezzo di acquisto + una quota della spesa di ristrutturazione) × (1 + rivalutazione annua)^anni di investimento. La quota di ristrutturazione attribuita al valore è il 75% di default (personalizzabile in modalità avanzata): un euro speso in lavori non diventa necessariamente un euro di valore di mercato in più.",
    ...
    note:
      "È il prezzo di vendita stimato, non la plusvalenza tassabile: oggi CasaFlow non modella l'eventuale tassazione della plusvalenza (imposta sostitutiva 26% o IRPEF, dovuta solo se si vende entro 5 anni dall'acquisto) — un tema aperto, non ancora implementato. Il costo pieno della ristrutturazione resta comunque un'uscita di cassa al 100% al momento della spesa, indipendentemente da questo coefficiente: la quota di valorizzazione incide solo sul valore di realizzo finale, non riduce né sostituisce l'esborso iniziale.",
  },
  {
  ...
  },
  {
    ...
    comeSiCalcola: "Stima di default: 1.000€ fisso + 0,5% del prezzo di acquisto, sovrascrivibile con un importo assoluto.",
    quandoSiApplica: "Sempre.",
    quandoSiPaga: "Alla data di acquisto.",
    aliquote: "1.000€ + 0,5% del prezzo (stima di default).",
    note:
      "Non è una regola pubblicata: gli onorari notarili sono liberamente negoziabili dal 2006 (nessun tariffario ufficiale in vigore), quindi non esiste una fonte normativa da citare per questa formula. È un'assunzione basata su alcuni dati empirici osservati, non uno standard di settore verificabile — verifica sempre col preventivo reale del tuo notaio.",
  },
  {
    id: "visure",
  ...
  },
  {
    ...
    comeSiCalcola: "Stima di default: 20€/mq/anno (quota straordinaria, tipicamente a carico del proprietario), sovrascrivibile con un importo annuo assoluto.",
  ...
  },
  {
    ...
    comeSiCalcola: "Percentuale annua del prezzo di acquisto — di default 0,1% (personalizzabile).",
    quandoSiApplica: "Sempre.",
    quandoSiPaga: "Il 1° gennaio di ogni anno pieno (o pro-rata negli anni parziali).",
  },
  {
  ...
  },
  {
    ...
    comeSiCalcola: "Stima di default 2€/mq, sovrascrivibile con un importo annuo assoluto.",
